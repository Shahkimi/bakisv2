...
<div class="min-h-[calc(100vh-4rem)] flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8" x-data="{ openSection: 'membership' }">
    <div class="w-full max-w-6xl flex flex-col md:flex-row gap-6 my-auto">
        ...
        <div class="flex-1 min-w-0">
            ...
            <form id="member-edit-form" action="{{ route('user.members.update', $member) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
                ...
                <div class="flex flex-wrap gap-3 justify-end pt-2">
                    <a href="{{ route('user.members.index') }}" class="inline-flex items-center justify-center px-6 py-3 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all">
                        Batal
                    </a>
...
[x-cloak] { display: none !important; }
    ...
    .select2-results__option { padding: 0.5rem 1rem; transition: background-color 0.1s; border-bottom: 1px solid transparent; }
