...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    <x-user.page-header
        current="Kutipan Yuran"
        title="Kutipan Yuran"
        subtitle="Cari ahli dan proses kutipan yuran pembaharuan"
        icon="kutipan"
        variant="emerald"
    />
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const memberUrlTemplate = @json(route('user.kutipan.member', ['encryptedNoKp' => '__ID__']));
    const autocompleteUrl = @json(route('user.kutipan.autocomplete'));
