...
<head>
    ...
    <title>Tukar kata laluan sementara - BAKIS</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .back-link a:hover, .back-link button:hover { text-decoration: underline; }
    </style>
</head>
<body>
    <section class="card">
        <div class="card-inner">
            ...
            <h1>Tukar kata laluan sementara</h1>
            <p class="subtitle">Akaun anda menggunakan kata laluan sementara. Sila tetapkan kata laluan baharu untuk meneruskan.</p>

            <form action="{{ route('password.change.update') }}" method="POST" id="changeForm">
                @csrf
                @method('PUT')
