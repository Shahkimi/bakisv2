...
<div class="max-w-3xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    <div class="mb-6 flex flex-col gap-3">
        @include('admin.kawalan.partials.breadcrumb', ['current' => 'Favicon'])
        <div class="flex flex-row items-start gap-4 group">
        <div class="flex-shrink-0 w-14 h-14 rounded-2xl bg-gradient-to-br from-violet-500 to-purple-600 shadow-lg shadow-violet-500/30 flex items-center justify-center">
            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
        </div>
        <div class="min-w-0 flex-1">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Favicon</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Muat naik atau buang ikon tapak web. Perubahan digunakan pada semua halaman selepas disimpan.</p>
        </div>
        </div>
    </div>
