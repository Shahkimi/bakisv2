...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8 flex flex-col gap-3">
        @include('admin.kawalan.partials.breadcrumb', ['current' => 'Kawalan Jabatan'])
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div class="flex items-center gap-4 group">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Kawalan Jabatan</h1>
...
$(document).ready(function() {
    ...
    function renderActionsButton(row) {
        ...
        return '<div class="flex flex-wrap items-center gap-1.5">' +
            '<button type="button" class="btn-edit-jabatan inline-flex items-center justify-center w-9 h-9 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition shadow-sm hover:shadow" title="Edit jabatan" aria-label="Edit jabatan" ' +
            'data-id="' + id + '" data-nama="' + nama + '" data-active="' + active + '">' + iconEdit + '</button>' +
            '<button type="button" class="btn-delete-jabatan inline-flex items-center justify-center w-9 h-9 rounded-lg bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 hover:bg-red-200 dark:hover:bg-red-800/50 transition shadow-sm hover:shadow" title="Padam jabatan" aria-label="Padam jabatan" ' +
            'data-id="' + id + '" data-nama="' + nama + '">' + iconTrash + '</button></div>';
    }
