...
$(document).ready(function () {
    ...
    function renderMemberCell(row) {
        ...
        let editLink = member.route_key
            ? `<a href="/admin/members/${member.route_key}/edit" class="mt-1 inline-flex items-center gap-1 text-xs text-indigo-500 dark:text-indigo-400 hover:text-indigo-700 hover:underline">
